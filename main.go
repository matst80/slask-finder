...
func Init() {
	...
	idx.AddKeyField(&facet.BaseField{Id: 11, Name: "Underkaterori", Description: "Sub category", Priority: 2999999999.0, IgnoreIfInSearch: true})
	...
	idx.AddKeyField(&facet.BaseField{Id: 20, Name: "B grade", Description: "Outlet rating", Priority: 19999.0, Type: "bgrade"})
	//idx.AddBoolField(&facet.BaseField{Id: 21, Name: "Discounted", Description: "",Priority: 999999999.0})
	idx.AddIntegerField(&facet.BaseField{Id: 4, Name: "Pris", Priority: 9999999999.0, Type: "currency"})
	idx.AddIntegerField(&facet.BaseField{Id: 5, Name: "Tidigare pris", Priority: 9999999999.0, Type: "currency"})
	idx.AddIntegerField(&facet.BaseField{Id: 6, Name: "Betyg", Description: "Average rating", Priority: 999999999.0, Type: "rating"})
	idx.AddIntegerField(&facet.BaseField{Id: 7, Name: "Antal betyg", Description: "Total number of reviews", Priority: 999999999.0})
	idx.AddIntegerField(&facet.BaseField{Id: 8, Name: "Rabatt", Description: "Discount value", Priority: 999999999.0, Type: "currency"})
	addDbFields(idx)
	//srv.Sorting.LoadAll()

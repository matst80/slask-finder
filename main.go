...
var embeddingsEngine types.EmbeddingsEngine = embeddings.NewOllamaEmbeddingsEngineWithMultipleEndpoints("nomic-embed-text", "http://10.10.11.98:11434/api/embeddings", "http://10.10.11.98:11434/api/embeddings")

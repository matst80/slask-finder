...
func Init() *server.WebServer {
	...
	srv.Index.AddKeyField(&facet.BaseField{Id: 1, Name: "Article Type", HideFacet: true})
	...
	srv.Index.AddKeyField(&facet.BaseField{Id: 11, Name: "Category parent", HideFacet: true})
	srv.Index.AddKeyField(&facet.BaseField{Id: 12, Name: "Master category", HideFacet: true})
	...
	srv.Index.AddIntegerField(&facet.BaseField{Id: 4, Name: "Price", Description: "Current price"})
	srv.Index.AddIntegerField(&facet.BaseField{Id: 5, Name: "Regular price", Description: "Regular price"})
	srv.Index.AddIntegerField(&facet.BaseField{Id: 6, Name: "Average rating", Description: "Average rating"})

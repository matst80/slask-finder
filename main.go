...
var embeddingsEngine types.EmbeddingsEngine = embeddings.NewOllamaEmbeddingsEngineWithMultipleEndpoints("mxbai-embed-custom", "http://10.10.11.98:11434/api/embeddings", "http://10.10.10.100:11434/api/embeddings")
